...
public class Main {
    ...
    public static String generateHospID(String role) 
    {
        Random random = new Random();
        int randomNumber = random.nextInt(900) + 100; // Generates a random number between 100 and 999
        switch (role) {
    ...
    private static void createNewAccount(Scanner scanner) {
        ...
        String hospitalID = generateHospID(role);
        System.out.println("Your Hospital ID is: " + hospitalID);
